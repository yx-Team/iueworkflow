<template>
    <div class="gulp-list page-move">
        ...
        <el-scrollbar style="height:467px;padding-top:10px;">
            
            <div class="list">
                <div class="list-item" :class="{'is-active':runIndex===index}" v-for="(item,index) in searchList" :key="index">
                    <div class="list-item-top">
                        <a :class="{'open':runIndex===index}" href="javascript:;">
                            <i v-if="runIndex===index" class="el-icon-loading"></i>
                ...
                <div class="list-item add-item" @click="handleCreateGulp" v-if="listCount<4">
        ...
        <div class="fixed-btn" @click="handleCreateGulp" v-if="listCount>3">
